...
#provide  nessery deatils to login
...
# wirte a fucntion for loging out
...
# fucntion to create or place an order
...
# uploding image of the defective product
@api.route("/download/<path:filename>")
def download(filename):
    return send_file(os.path.join(UPLOAD_FOLDER, filename), as_attachment=True)
# for searching order to place
...
# for placing the order to the customers place
